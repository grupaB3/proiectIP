...
public class DiskInvestigatorInfoProcessPanelPart3 extends JPanel{
	/**
	 * 
	 */
	...
	public DiskInvestigatorInfoProcessPanelPart3(Dimension frameSize, Observer observer){
	...
	private void init(Dimension frameSize,Observer observer){
	    	...
	    	componentsTitleTextArea.setText("          Disk Manager Tasks Tab Components");
	    	...
	    	componentsIntroTextArea.setText("         Below you can see the Processes Module window of the application, with the Tasks Tab being selected.");
			...
			try {
				//myPicture = ImageIO.read(new File("processPanel_taskTab.png"));
				myPicture=ImageIO.read(getClass().getResource("processPanel_taskTab.png"));
			} catch (IOException e) {
			}
		...
		private JPanel descriptionTabel(JPanel componentsPanel) {
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST, tableComponentDesc,112,SpringLayout.EAST, tableComponentPart);
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST,firstComponentDesc,65,SpringLayout.EAST,firstComponent);
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST,secondComponentDesc,90,SpringLayout.EAST,secondComponent);
	    	...
	    	thirdComponent.setText("3. Start Task Button");
	    	...
	    	thirdComponentDesc.setText("Start Task Button Description");
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST,thirdComponentDesc,51,SpringLayout.EAST,thirdComponent);
	    	...
	    	fourthComponent.setText("4. Stop Task Button");
	    	...
	    	fourthComponentDesc.setText("Stop Task Button Description");
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST,fourthComponentDesc,52,SpringLayout.EAST,fourthComponent);
	    	...
	    	fifthComponent.setText("5. Task Info Area");
	    	...
	    	fifthComponentDesc.setText("Task Info Area Description");
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST,fifthComponentDesc,74,SpringLayout.EAST,fifthComponent);
	    	...
	    	sixthComponent.setText("6. Task Display Area");
	    	...
	    	sixthComponentDesc.setText("Task Display Area Description");
	    	...
	    	springLayout.putConstraint(SpringLayout.WEST,sixthComponentDesc,52,SpringLayout.EAST,sixthComponent);
