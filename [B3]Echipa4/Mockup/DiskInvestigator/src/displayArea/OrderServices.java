...
public class OrderServices extends JPanel {
	...
	private void initUI() {
		...
		pid.setPreferredSize(new Dimension(50, 30));
		JLabel description = new JLabel("Description");
		description.setPreferredSize(new Dimension(150, 30));
		JLabel status = new JLabel("Status");
		status.setPreferredSize(new Dimension(70, 30));
		
		JSplitPane splitPane1 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, name, pid);
	    splitPane1.setDividerSize(2);
	    splitPane1.setDividerLocation(0.5);
		JSplitPane splitPane2 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, splitPane1, description);
	    splitPane2.setDividerLocation(0.4);
	    splitPane2.setDividerSize(2);
	    JSplitPane splitPane3 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, splitPane2, status);
