...
public class OrderProcesses extends JPanel {
	...
	private void initUI() {
		...
		memory.setPreferredSize(new Dimension(150, 30));
		
		JSplitPane splitPane1 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, name, user);
	    splitPane1.setDividerSize(2);
	    splitPane1.setDividerLocation(0.5);
		JSplitPane splitPane2 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, splitPane1, processor);
	    splitPane2.setDividerLocation(0.4);
	    splitPane2.setDividerSize(2);
	    JSplitPane splitPane3 = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true, splitPane2, memory);
